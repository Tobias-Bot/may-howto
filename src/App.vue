      ...
      <v-container fluid>
        <!-- <v-dialog v-model="dialogSwitch" scrollable>
          <v-card color="#F0D5CE">
            ...
            <v-divider></v-divider>
            <v-card-actions>
              <v-btn color="#6E5F5B" text @click="dialogSwitch = !dialogSwitch">
                <v-icon>mdi-close</v-icon>
              </v-btn>
              <v-btn color="#6E5F5B" text @click="subscribeOnGroup">
                Подписаться
              </v-btn>
            </v-card-actions>
          </v-card>
        ...
        <v-dialog v-model="dialogNotifySwitch" scrollable persistent>
          <v-card color="#F0D5CE">
            ...
            >
              <br />
              Для дальнейшей работы приложения нужно разрешить доступ к
        ...
        <v-dialog v-model="dialogVkDonut" scrollable persistent>
          <v-card color="#F0D5CE">
            ...
            <v-divider></v-divider>
            <v-card-text
              style="text-align: center; padding: 20px; font-weight: 500; font-size: 14px; max-height: 400px;"
            >
